...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname overlay-starter) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
(require 2htdp/image)
;; overlay-starter.rkt
...
(overlay (star 60 "solid" "blue")
         (star 100 "solid" "red")
         (star 140 "solid" "black"))
