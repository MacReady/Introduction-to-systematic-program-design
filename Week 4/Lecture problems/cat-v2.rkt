...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname cat-v2) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
(require 2htdp/image)
...
;; Cat KeyEvent -> Cat
;; reste cat to left edhe when space key is pressed
