...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname countdown-to-display) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
(require 2htdp/image)
...
(check-expect (countdown-to-image false) (square 0 "solid" "blue"))
...
;(define (countdown-to-image c) (square 0 "solid" "blue")) ;stub
